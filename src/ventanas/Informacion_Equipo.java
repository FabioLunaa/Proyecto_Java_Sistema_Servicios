...
public class Informacion_Equipo extends javax.swing.JFrame {
    ...
    String user = "", nom_cliente = "";//nom_cliente es la var q guardará el nombre q traeré de la bd.

    public Informacion_Equipo() {
        initComponents();
        user = Login.user;//traigo user de otra ventana.
        idEquipo = Informacion_Cliente.IDequipos;//traigo IDequipos de otra ventana.
        IDcliente_update = Gestionar_Clientes.IDcliente_update;//traigo IDcliente de otra ventana.
        ...
        try {
            ...
            if (rs.next()) {
                //traje el nombre del cliente de la bd y la coloco en la new var.
                nom_cliente = rs.getString("nombre_cliente");
            } 

        } catch (SQLException e) {
            System.err.println("ERROR al cargar nombre del cliente." + e);
...
/*de igual forma debemos ir a JFrame, clic derecho y propiedades, IconImage clic en ..., value from existing component,
    ...
    private void jButton_actualizarEquipoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_actualizarEquipoActionPerformed
        ...
        observaciones = jTextPane_dañosObservaciones.getText();
        ...
        if (observaciones.equals("")) {
            jTextPane_dañosObservaciones.setText("Sin observaciones");
        ...
        if (validacion == 0) {
            try {
                Connection cn = Conexion.conectar();
                PreparedStatement pst = cn.prepareStatement(
                        "update equipos set tipo_equipo=?, marca=?, modelo=?, num_serie=?, observaciones=?, estatus=?, ultima_modificación=? "
